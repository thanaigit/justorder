...
Future<void> timerMessageDialog(
  ...
  return showDialog<void>(
    ...
    builder: (context) {
      ...
      Future.delayed(Duration(milliseconds: 500 + milliseconds), () => closePage());
      return SimpleDialog(
        shape: const RoundedRectangleBorder(
          borderRadius: BorderRadius.all(Radius.circular(AppSize.generalBorderRadius)),
        ),
        title: Column(
          children: [
            Icon(
